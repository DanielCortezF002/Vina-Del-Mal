...
export const MOCK_PRODUCTS: Product[] = [
  ...
  { id: 4, name: 'Vodka Grey Goose', slug: 'grey-goose', price: 42000, category: 'Vodka', categorySlug: 'vodka', brand: 'Grey Goose', alcoholPercentage: 40, imageUrl: 'https://images.unsplash.com/photo-1614316131362-e6e22f280a74?q=80&w=600&auto=format&fit=crop', isActive: true },
  ...
  { id: 7, name: "Jack Daniel's Old No. 7", slug: 'jack-daniels', price: 28000, category: 'Whisky', categorySlug: 'whisky', brand: "Jack Daniel's", alcoholPercentage: 40, imageUrl: 'https://images.unsplash.com/photo-1620037458978-ce98d7c7c2d2?q=80&w=600&auto=format&fit=crop', isActive: true },
